...
export default function Page() {
  ...
  return (
    <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 pt-12 md:p-16 md:pt-24 pb-20 print:p-12">
      <motion.div
        initial={{ opacity: 1 }}
        animate={{ opacity: animationComplete ? 1 : 0.1 }}
      ...
      >
        ...
        <motion.section
          id="top"
          className="mx-auto w-full max-w-4xl space-y-12 bg-white print:space-y-8"
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex-1 space-y-1.5">
              ...
              <div className="flex gap-x-5 md:gap-x-6 pt-3 font-mono text-sm text-muted-foreground print:hidden">
          ...
          {RESUME_DATA.achievements && RESUME_DATA.achievements.length > 0 && (
            <div className="scroll-mt-16" id="achievements-news">
              <AchievementsNewsSection
                achievements={RESUME_DATA.achievements as any}
              />
            </div>
          )}
              ...
              {RESUME_DATA.researchProjects.map((project, index) => (
                ...
                >
                  <ProjectCard
                    ...
                    link={"link" in project ? (project as any).link.href : undefined}
                  />
                </motion.div>
              ))}
            </div>
