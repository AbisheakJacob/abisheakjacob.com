            ...
            <div className="rounded-lg border border-muted bg-card p-4 shadow-sm transition-all duration-300 hover:bg-card/95 hover:shadow group-hover:border-muted/80">
              ...
              <div className="mb-2 flex flex-wrap gap-1">
                <span className="font-mono text-sm font-medium">
                  {work.roles ? "Progressive Roles" : work.title}
                </span>
                <div className="flex-1" />
                {work.badges.map((badge) => (
              ...
              {work.roles && (
                <div className="mt-4 flex flex-col gap-4 pl-2 border-l-2 border-muted border-dashed">
                  {work.roles.map((role, idx) => (
                    <div key={idx} className="relative pl-4">
                      <div className="absolute -left-[5px] top-2 h-2 w-2 rounded-full bg-muted-foreground/50" />
